      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        {post.images.length > 0 && (
          <div className="relative">
            <img
              src={`http://localhost:4000/uploads/posts/${post.images[currentImage]}`}
              alt={post.title}
                  ...
                  <img
                    src={
                      currentUser.profileImage === "default-profile.jpg"
                        ? "/default-profile.jpg"
                        : `http://localhost:4000/uploads/profiles/${currentUser.profileImage}`
                    }
    ...
    <div className="space-y-4">
      {commentsToShow.map((comment) => (
        <div key={comment._id} className="flex items-start">
          <img
            src={
              comment.profileImage === "default-profile.jpg"
                ? "/default-profile.jpg"
                : `http://localhost:4000/uploads/profiles/${comment.profileImage}`
            }
            alt={comment.name}
            className="w-10 h-10 rounded-full mr-3 object-cover"
          />
